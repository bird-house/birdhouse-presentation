...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=10cm]{images/phoenix.png}
  \end{figure}
\end{frame}
...
>> birdy -h
  \end{verbatim}
  \begin{figure}
    \includegraphics[width=10cm]{images/birdy-terminal}
  \end{figure}
\end{frame}
